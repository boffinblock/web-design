    ...
    <div className="w-[60%] max-sm:w-full mx-auto">
        <div className=" w-[60%] mx-auto justify-center">
            <h1 className="font-nunito text-gray-700 font-medium text-4xl">Do you wrok with doctors? <br />
                <span>
                    Support them with klaim
                </span>
                </h1>

                <p className=" mt-7 text-md text-gray-600">
                    Our mission is drivn growth, with an estimated minimun of $12.2bn an  annual opportunity across the market.As you trusted partner , we will help you to unlock thi opportunity with access to klair range of finical services solutions
                </p>
