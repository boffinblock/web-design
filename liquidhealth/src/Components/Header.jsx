                ...
                <div className=" w-[85%] h-[7rem] mx-auto flex justify-between max-sm:gap-2 items-center">
                    ...
                    <div className="">
                        <ul className="flex gap-8 list1 tracking-[1px]">
                            <li className="text-[18px]"><Link to="company" spy={true} smooth={true} offset={-50} duration={500} activeClassName="active" exact >Company</Link></li>
                            <li className="text-[18px]"><Link to="solution" spy={true} smooth={true} offset={-50} duration={500} activeClassName="active">Solution</Link></li>
                            <li className="text-[18px]"><Link to="partner" spy={true} smooth={true} offset={-50} duration={500} activeClassName="active">Partner</Link></li>
                            <li className="text-[18px]"><Link to="contact" spy={true} smooth={true} offset={-50} duration={500} activeClassName="active">Contact</Link></li>
                        </ul>
